...
namespace whm {
    ...
    public class ColdShowersMonthlyStatisticsController : Controller, IMonthlyStatisticsController
    {
        ...
        public void SetMonthlyOverview()
        {
            ...
            if (GameController.instance.SavedResultModelRegistry.doesMonthHaveData(SavedResultType.ColdShowers, UIController.instance.selectedMonth)) {
        ...
        {
            List<SavedResultModel> monthlyResults = GameController.instance.SavedResultModelRegistry.getAnEntireMonthsResults(SavedResultType.ColdShowers, UIController.instance.selectedMonth); 
