...
namespace whm {
    ...
    public class BreathingCompletionController : Controller
    {
        ...
        public void SaveButtonClick()
        {
            ...
            SavedResultModel result = new SavedResultModel(SavedResultType.Breathing, 0, roundTimes, 0, null);
            GameController.instance.SavedResultModelRegistry.addASpecificResult(SavedResultType.Breathing, result);
